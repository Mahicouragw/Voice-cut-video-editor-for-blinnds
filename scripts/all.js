...
async function publish(){
  ...
  await git(['-c','user.name=VoiceCut deployment automation','-c','user.email=voicecut-deployment@users.noreply.github.com','commit','-m','VoiceCut app 2.3: voice-over preview, delete range, tiny caption uploads, ultra cleanup']);
